...
export class Schedules extends BaseResource {
  ...
  async update({
    ...
    return this.client.put<Schedule>(`/agents/${agentId}/schedules/${scheduleId}`, data, options);
  }
  ...
  async trigger({
    ...
    await this.client.post(
      `/agents/${agentId}/schedules/${scheduleId}/trigger`,
      undefined,
      options,
    );
  }
  ...
  async runs({
    ...
    return this.client.get<ScheduleRun[]>(`/agents/${agentId}/schedules/${scheduleId}/runs`, {
      ...options,

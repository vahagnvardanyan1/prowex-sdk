...
export class Analytics extends BaseResource {
  async dashboard(range?: DateRange, options?: RequestOptions): Promise<DashboardData> {
  ...
  async daily(range?: DateRange, options?: RequestOptions): Promise<DailySummary[]> {
  ...
  async byAgent(range?: DateRange, options?: RequestOptions): Promise<AgentSummary[]> {
  ...
  async byModel(range?: DateRange, options?: RequestOptions): Promise<ModelSummary[]> {
